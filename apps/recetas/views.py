...
class RecetasView(APIView):
    ...
    def get(self, request):
        ...
        datos_json= RecetasSerializer(data, many=True)
    ...
    def post(self, request):
        ...
        if request.FILES["foto"].content_type=="image/jpeg" or request.FILES["foto"].content_type=="image/png":
            ...
            try:
                Recetas.objects.create(nombre=request.data["nombre"], tiempo=request.data.get("tiempo"), descripcion=request.data["descripcion"], categoria_id=request.data.get("categoria_id"), fecha=datetime.now(), foto=foto, user_id=resuelto["id"])
...
class EdicionRecetas(APIView):
    ...
    def put(self, request, id):
        ...
        try:
            Recetas.objects.filter(pk=id).update(nombre=request.data["nombre"], slug=slugify(request.data["nombre"]),tiempo=request.data.get("tiempo"), descripcion=request.data["descripcion"], categoria_id=request.data.get("categoria_id"))
